...
public class RequestOrdersHistory extends AppCompatActivity {

    private static final String TAG = "RequestOrdersHistory";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_request_orders_history);
        ...
        mContext = RequestOrdersHistory.this;
