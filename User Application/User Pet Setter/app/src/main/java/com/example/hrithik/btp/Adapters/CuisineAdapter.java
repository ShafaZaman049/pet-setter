...
public class CuisineAdapter extends RecyclerView.Adapter<CuisineAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        if(mCuisineList.get(position).getCuisineCode().trim().toLowerCase().equals(PostMenuActivity.cuisineSelected)){
        ...
        holder.layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PostMenuActivity.cuisineSelected = mCuisineList.get(position).getCuisineCode();
                notifyDataSetChanged();
                PostMenuActivity.cuisineOnClick(mContext ,mCuisineList.get(position).getCuisineCode(), mActivity);
            }
        });
