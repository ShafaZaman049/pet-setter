...
public class RequestCartActivity extends AppCompatActivity {

    private static final String TAG = "RequestCartActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_request_cart);
        ...
        cartAdapter = new CartAdapter(RequestCartActivity.this, RequestCartActivity.this, cartList);
        LinearLayoutManager cartManager = new LinearLayoutManager(RequestCartActivity.this, LinearLayoutManager.VERTICAL, false);
            ...
            checkoutBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(mAuth.getCurrentUser() != null) {
                        ...
                        Intent intent = new Intent(RequestCartActivity.this, PaymentActivity.class);
