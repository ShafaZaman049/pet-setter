...
import com.example.hrithik.btp.Activity.PostMenuActivity;
import com.example.hrithik.btp.Activity.RequestFeedbackCommentActivity;
import com.example.hrithik.btp.Activity.RequestOrdersHistory;
...
public class OrderFoodCommentAdapter extends RecyclerView.Adapter<OrderFoodCommentAdapter.ViewHolder>{
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.custom_comment_single_row, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        holder.foodPrice.setText("Rs."+mFoodList.get(position).getFoodPrice());
        holder.foodQty.setText("x"+mFoodList.get(position).getFoodQty());
        holder.foodPriceTotal.setText("Rs."+ (Integer.valueOf(mFoodList.get(position).getFoodPrice())
        ...
        holder.foodCommentLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mFoodList.get(position).getFoodcomment().equals("null")) {
                    ...
                    View mView = mActivity.getLayoutInflater().inflate(R.layout.custom_comment_dialog, null);
                    ...
                    submitBtn.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            if (!foodCommentET.getText().toString().trim().equals("")) {
                                ...
                                float pos_score = RequestFeedbackCommentActivity.processReview(cleaned_review);
                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if(task.isSuccessful()){
                                        ...
                                        //RequestFeedbackCommentActivity.orderFoodCommentAdapter.notifyDataSetChanged();
                                        //RequestFeedbackCommentActivity.populateList();
                                        ...
                                        dialog.dismiss();
                                        comment_progress.dismiss();
                                        RequestOrdersHistory.getOrdersFromServer();
                                        RequestFeedbackCommentActivity.populateList();
                                        PostMenuActivity.getFoodListFromServer();
                                        //mActivity.finish();
