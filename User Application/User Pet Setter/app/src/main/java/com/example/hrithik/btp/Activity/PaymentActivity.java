...
public class PaymentActivity extends AppCompatActivity implements PaytmPaymentTransactionCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent intent1 = new Intent(PaymentActivity.this, PaymentOrderStatusActivity.class);
        intent1.putExtra("status","TXN_SUCCESS");
...
//        d1.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
    ...
    public void onBackPressedCancelTransaction() {
        ...
        Intent intent = new Intent(PaymentActivity.this, PostMenuActivity.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK|Intent.FLAG_ACTIVITY_NEW_TASK);
        startActivity(intent);
        finish();
