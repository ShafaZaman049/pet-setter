...
import com.example.hrithik.btp.Activity.RequestCartActivity;
...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.ViewHolder>{
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.single_row_post_cart_layout, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        holder.cartFoodPrice.setText("RS. "+mCartList.get(position).getFood().getFoodPrice());
        ...
        holder.cartFoodTotal.setText("Rs. "+singleItemTotal);
        ...
        holder.cartfoodClose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                RequestCartActivity.updateCartDetails();
