...
public class PostMenuActivity extends AppCompatActivity {
    ...
    private static  String TAG = "PostMenuActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContext = PostMenuActivity.this;
        mActivity = PostMenuActivity.this;
        ...
        imgsetup=findViewById(R.id.editsetup);
        ...
        imgsetup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(PostMenuActivity.this,SetupActivity.class));
            }
        });
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                auth.signOut();
                startActivity(new Intent(PostMenuActivity.this,LoginActivity.class));
            }
        });
        orderHistoryIcon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(PostMenuActivity.this, RequestOrdersHistory.class));
            }
        });
       ...
       // addDataToDatabase();
        ...
        foodCartIV.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(PostMenuActivity.this, RequestCartActivity.class));
            }
        });
        ...
        PostMenuActivity.updateCartItemCountIcon();
    ...
    public static void getFoodListFromServer(){
        ...
        query.addSnapshotListener(mActivity, new EventListener<QuerySnapshot>() {
            ...
            public void onEvent(QuerySnapshot queryDocumentSnapshots, FirebaseFirestoreException e) {
                ...
                System.out.println("data__________________"+queryDocumentSnapshots);
                if(queryDocumentSnapshots!=null && !queryDocumentSnapshots.isEmpty()){

                    for(DocumentChange doc : queryDocumentSnapshots.getDocumentChanges()){
                        System.out.println("data__________________22222"+queryDocumentSnapshots.toString());
    ...
    public static void cuisineOnClick(Context context, String cuisineCode, Activity activity){
        ...
        PostMenuActivity foodMenuActivity = new PostMenuActivity();
    ...
    private static void addcuisines() {
        ...
        cuisineArrayList.add(new Cuisine("101","Cats"));
        cuisineArrayList.add(new Cuisine("102","Dogs"));
        cuisineArrayList.add(new Cuisine("103","Parrot"));
        cuisineArrayList.add(new Cuisine("104","Raptiles"));
        cuisineArrayList.add(new Cuisine("105","Rabbit"));
...
//        Intent backToMainIntent = new Intent(PostMenuActivity.this, MainActivity.class);
