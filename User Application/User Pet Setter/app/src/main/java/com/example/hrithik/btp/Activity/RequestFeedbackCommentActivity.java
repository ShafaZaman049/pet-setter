...
public class RequestFeedbackCommentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_request_feedback_comment);
        ...
        mContext = this;
        mActivity = RequestFeedbackCommentActivity.this;
    ...
    private static float runModel(float[][] input_val, float[][] outputValue) {
        ...
        float output[] = RequestFeedbackCommentActivity.outputValue[0];
