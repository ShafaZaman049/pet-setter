...
public class FoodAdapter extends RecyclerView.Adapter<FoodAdapter.ViewHolder>{
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.single_row_post_layout, viewGroup, false);
        ...
        holder.layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               /* Intent intent = new Intent(mContext, FoodDetailsActivity.class);
                ...
                View mView = mActivity.getLayoutInflater().inflate(R.layout.custom_post_dialog, null);
